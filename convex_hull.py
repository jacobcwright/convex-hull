...
class ConvexHullSolver(QObject):
    ...
    # recursive helper function for computing the convex hull
    ...
    # merge two given hulls and return the merged hull
    ...
    # get upper tangent between two hulls and return two points, one from each hull
    ...
    # get lower tangent between two hulls and return two points, one from each hull
    ...
    #  return the index of the point in hull that has the maximum slope with respect to starting point (Clockwise)
    ...
    #  return the index of the point in hull that has the maximum slope with respect to starting point (Counter Clockwise)
